...
type Copy = {
  catalogue: string; issue: string; language: string;
...
const copy: Record<Locale, Copy> = {
  en: {
    catalogue: "Open Food Facts catalogue", issue: "Issue 01 · Product finder", language: "Display language",
  ...
  nl: {
    catalogue: "Open Food Facts-catalogus", issue: "Editie 01 · Productzoeker", language: "Weergavetaal",
  ...
  de: {
    catalogue: "Open Food Facts Katalog", issue: "Ausgabe 01 · Produktsuche", language: "Anzeigesprache",
  ...
  fr: {
    catalogue: "Catalogue Open Food Facts", issue: "Édition 01 · Recherche de produits", language: "Langue de l'interface",
